...
namespace MarkovJunior
{
    ...
    static class SymmetryHelper
    {
        ...
        /// <param name="subgroup"><inheritdoc cref="GetSymmetry(bool, string, bool[])" path="/returns"/> If <c>null</c>, the full symmetry group is used.</param>
        ...
        /// </summary>
        /// <param name="thing"><inheritdoc cref="SquareSymmetries{T}(T, Func{T, T}, Func{T, T}, Func{T, T, bool}, bool[])" path="/param[@name='thing']"/></param>
        ...
        /// <param name="r"><inheritdoc cref="SquareSymmetries{T}(T, Func{T, T}, Func{T, T}, Func{T, T, bool}, bool[])" path="/param[@name='reflection']"/></param>
        /// <param name="same"><inheritdoc cref="SquareSymmetries{T}(T, Func{T, T}, Func{T, T}, Func{T, T, bool}, bool[])" path="/param[@name='same']"/></param>
        /// <param name="subgroup"><inheritdoc cref="SquareSymmetries{T}(T, Func{T, T}, Func{T, T}, Func{T, T, bool}, bool[])" path="/param[@name='subgroup']"/></param>
