...
namespace MarkovJunior
{
    ...
    abstract class WFCNode : Branch
    {
        ...
        /// <summary>The index of the first unused entry in the <see cref="stack">stack</see>.</summary>
        int stacksize;
        ...
        /// <summary>
        /// If <c>true</c>, then the next execution step will initialise <see cref="startwave">startwave</see>
        ...
        /// <param name="random"><inheritdoc cref="random" path="/summary"/></param>
        ...
        /// <summary>
        /// Propagates the constraints, using the <see cref="stack">stack</see>
    ...
    class Wave
    {
        ...
        /// <param name="D"><inheritdoc cref="Wave(int, int, int, bool)" path="/param[@name='D']"/></param>
        /// <param name="shannon"><inheritdoc cref="WFCNode.shannon" path="/summary"/></param>
