...
namespace MarkovJunior
{
    ...
    class TileNode : WFCNode
    {
        ...
        override protected bool Load(XElement xelem, bool[] parentSymmetry, Grid grid)
        {
            ...
            XDocument xdoc;
            string filepath = $"Assets/Resources/MarkovJunior/resources/tilesets/{name}.xml";
            ...
            int[] firstData;
            int SY;
            (firstData, S, SY, SZ) = VoxHelper.LoadVox($"Assets/Resources/MarkovJunior/resources/tilesets/{firstFileName}");
            ...
            foreach (XElement xtile in xtiles)
            {
                ...
                string filename = $"Assets/Resources/MarkovJunior/resources/tilesets/{tilesname}/{tilename}.vox";
