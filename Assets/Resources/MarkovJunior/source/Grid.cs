...
namespace MarkovJunior
{
    class Grid
    {
        ...
        /// <summary>Maps each alphabet symbol to its color, i.e. its index in <see cref="characters">characters</see>.</summary>
        ...
        /// <param name="MX"><inheritdoc cref="MX" path="/summary"/></param>
        /// <param name="MY"><inheritdoc cref="MY" path="/summary"/></param>
        /// <param name="MZ"><inheritdoc cref="MZ" path="/summary"/></param>
